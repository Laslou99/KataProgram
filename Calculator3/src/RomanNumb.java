public enum RomanNumb { I(1), II(2), III(3),
    ...
    private int arabicNumb;

    RomanNumb(int arabicNumb) {
        this.arabicNumb = arabicNumb;
    }

    public int getArabicNumb() {
        return arabicNumb;
    }
